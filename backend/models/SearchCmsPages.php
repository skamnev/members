...
/**
 * SearchCmsPages represents the model behind the search form about `backend\models\CmsPages`.
 */
class SearchCmsPages extends CmsPages
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['title', 'content', 'content_heading', 'identifier', 'code_id', 'category_id', 'mapping_id', 'meta_keywords', 'meta_description', 'created_at', 'updated_at'], 'safe'],
        ];
    }
