...
<div class="diary-nutrition-update-form">
    
     <?php $form = ActiveForm::begin([
        'action' => ['members/update-nutrition-comment?id=' . $model->id],
        'enableAjaxValidation' => false,
        'enableClientValidation' => true,
        'id' => 'update-training-comment-form'
    ]); ?>
...
<?php
$this->registerJs('
    $("#update-training-comment-form").on("beforeSubmit", function(){
        ...
        .done(function(result) {
            ...
            $("#statusMsg").animate({
                ...
                $("#nutrition-comment-" + result.attributes["id"]).html(result.attributes["comment"]);
            });
