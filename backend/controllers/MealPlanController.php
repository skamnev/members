...
use backend\models\SearchMealPlans;
...
/**
 * MealPlanController implements the CRUD actions for CmsMealPlan model.
 */
class MealPlanController extends Controller
{
    ...
    /**
     * Lists all CmsMealPlan models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SearchMealPlans;
    ...
    /**
     * Displays a single CmsMealPlan model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new CmsMealPlan model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new CmsMealPlan();
    ...
    /**
     * Deletes an existing CmsMealPlan model.
