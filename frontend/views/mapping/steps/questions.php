...
$questionsAnswers = $steps['questionsAnswers'];

$questionsModel = \backend\models\MappingQuestions::find()->where(['category_id' => $category['id'], 'is_active' => 1])->orderBy('order DESC')->with('fieldsTypes')->all();
?>
