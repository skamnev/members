...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['firstname', 'lastname', 'email', 'weight', 'height', 'birthday'], 'required', 'on' => 'mapping'],
            ['email', 'unique'],
    ...
    public static function isActive () {
        if (Yii::$app->user->isGuest || Yii::$app->getUser()->identity->status != self::STATUS_ACTIVE) {
            return false;
        }
