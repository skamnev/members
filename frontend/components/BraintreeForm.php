...
class BraintreeForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['customer_firstName', 'customer_lastName', 'customer_email'], 'required', 'on' => 'customer'],
            [['amount', 'creditCard_number', 'creditCard_cvv', 'creditCard_expirationDate'], 'required', 'on' => 'sale'],
            [['paymentMethodToken','planId'], 'required', 'on' => 'subscription'],
            ...
            [['creditCard_expirationMonth',
                ...
                'shipping_region',
                'shipping_postalCode',
                'shipping_countryCodeAlpha2', 'planId'], 'safe'],
        ];
    }
    ...
    {
        $return = \Yii::$app->get('braintree')->sendSubscription();
